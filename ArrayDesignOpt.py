...
if __name__ == "__main__":
    arr = AntennaArray(N=64)
    #print(arr.Xdata)
    #arr.showArrayCoordinates()
    _pat_norm, _domg, _cosxy, _radmin, _pat_int  = arr.getPattern()
    sll1, Xopt, Yopt, BeamOpt, Xlast1, Ylast1 = arr.minimizeSLL( 0.95*_radmin,gain=10, plotPattern=True)
    #arr.saveLocs2File()